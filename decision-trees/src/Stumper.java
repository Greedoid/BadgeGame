...
public class Stumper {
	...
	Instances testData = new Instances(new FileReader(new File(args[1])));
        double alphaConstant = Double.parseDouble(args[2]); //Passed in on command line, calculated in delta W later
	double convergeConstant = Double.parseDouble(args[3]);
