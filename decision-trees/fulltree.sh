...
# Appends all of the data sets in a horrendously inefficent way in order to isolate single folds
...
#Actually runs tree algorithm on all five folds
java -cp lib/weka.jar:bin WekaTester ./merges/2345.arff ./../badges.total1.arff -1
java -cp lib/weka.jar:bin WekaTester ./merges/1345.arff ./../badges.total2.arff -1
java -cp lib/weka.jar:bin WekaTester ./merges/1245.arff ./../badges.total3.arff -1
java -cp lib/weka.jar:bin WekaTester ./merges/1235.arff ./../badges.total4.arff -1
java -cp lib/weka.jar:bin WekaTester ./merges/1234.arff ./../badges.total5.arff -1
