...
#Append everything here to isolate folds
...
#Execute 8 stump here. 
java -cp lib/weka.jar:bin WekaTester ./merges/2345.arff ./../badges.total1.arff 8
java -cp lib/weka.jar:bin WekaTester ./merges/1345.arff ./../badges.total2.arff 8
java -cp lib/weka.jar:bin WekaTester ./merges/1245.arff ./../badges.total3.arff 8
java -cp lib/weka.jar:bin WekaTester ./merges/1235.arff ./../badges.total4.arff 8
java -cp lib/weka.jar:bin WekaTester ./merges/1234.arff ./../badges.total5.arff 8
